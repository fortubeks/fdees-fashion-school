                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Enrollments </h6>
                                    <p class="text-sm">See information about all enrollments</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    ...
                                    <a href="{{url('students/create')}}" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                                        ...
                                        <span class="btn-inner--text">Add enrollment</span>
                                    </a>
                                </div>
                            </div>
                        </div>
