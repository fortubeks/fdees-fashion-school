                ...
                <div class="col-md-12">
                    <div class="d-md-flex align-items-center mb-3 mx-2">
                        <div class="mb-md-0 mb-3">
                            ...
                            <p class="mb-0">Hope its going great!</p>
                        </div>
                        <button type="button"
                            class="d-none btn btn-sm btn-white btn-icon d-flex align-items-center mb-0 ms-md-auto mb-sm-0 mb-2 me-2">
                        ...
                        <button type="button" class="d-none btn btn-sm btn-dark btn-icon d-flex align-items-center mb-0">
                            <span class="btn-inner--icon">
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Revenue YTD</p>
                                        <h4 class="mb-2 font-weight-bold">₦ 0.00</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                                                <i class="fa fa-chevron-up text-xs me-1"></i>0.5%
                                            </span>
                                            <span class="text-sm ms-1">from ₦ 0.00</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Current Students</p>
                                        <h4 class="mb-2 font-weight-bold">{{getModelCount('students')}}</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                                                <i class="fa fa-chevron-up text-xs me-1"></i>1%
                                            </span>
                                            <span class="text-sm ms-1">from 0</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Courses</p>
                                        <h4 class="mb-2 font-weight-bold">{{getModelCount('courses')}}</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Enrollees</p>
                                        <h4 class="mb-2 font-weight-bold">{{getModelCount('enrollments')}}</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                                                <i class="fa fa-chevron-up text-xs me-1"></i>1%
                                            </span>
                                            <span class="text-sm ms-1">from 1</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
                    <div class="card shadow-xs border h-100">
                        <div class="card-header pb-0">
                            <h6 class="font-weight-semibold text-lg mb-0">Students over time</h6>
                            <p class="text-sm">Here you have details about your enrollees.</p>
                    ...
                    <div class="card shadow-xs border">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Recent Enrollees</h6>
                                    <p class="text-sm mb-sm-0 mb-2">These are details about the last registrations</p>
                                </div>
                        ...
                        <div class="card-body px-0 py-0">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center justify-content-center mb-0">
                                    ...
                                    <tbody>
                                        @foreach(getModelList('enrollments') as $enrollment)
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <p class="text-sm font-weight-normal mb-0">{{$enrollment->course->name}}</p>
                                            </td>
                                            <td>
                                                <span class="text-sm font-weight-normal">{{$enrollment->created_at->format('d-M-Y')}}</span>
                                            </td>
                                            <td>
