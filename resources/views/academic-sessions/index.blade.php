<x-app-layout>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="#" onclick="setSessionId(this)" data-id="{{$session->id}}" data-bs-toggle="modal" data-bs-target="#exampleModal" class="text-secondary font-weight-bold text-xs"
                                                    data-bs-toggle="tooltip" data-bs-title="Add course to session">
                                                ...
                                                <a href="{{url('/academic-sessions/'.$session->id)}}" class="text-secondary font-weight-bold text-xs"
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add Course To Session </h5>
