                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Students list</h6>
                                    <p class="text-sm">See information about all students</p>
                                </div>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7">Student Name
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class='clickable-row' data-href='{{url("/students/".$student->id)}}'>
                                            <td>
